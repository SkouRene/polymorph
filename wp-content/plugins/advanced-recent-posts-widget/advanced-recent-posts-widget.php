<?php
/*
Plugin Name: Polymorph: Recent Posts Plus+
Plugin URI: http://juhlsen.com
Description: Adds a widget that can display recent posts from multiple categories or from custom post types, add functionality and updated it to foundation css.
Version: 1.2
Author: René Skou
Author URI: http://tumblr.reneskou.com
*/
/*  
...
class Advanced_Recent_Posts_Widget extends WP_Widget {
	...
	function __construct() {
    	$widget_ops = array(
			...
			'description' => __('Shows recent posts / custom post types.')
		);
    	parent::__construct('advanced-recent-posts', __('Polymorph: Posts Plus+'), $widget_ops);
	}
	...
	function widget($args, $instance) {
		...
		?>
<div class="row">
			<div class="recent-post-item twelve columns">
				...
				?>
					...
					<img src="<?php echo $thumbnail[0] ; ?>" alt='<?php the_title_attribute(); ?>'  />

					</a>
					
				<?php endif; ?>

				<a  href="<?php the_permalink(); ?>" rel="bookmark" title="Permanent link to <?php the_title_attribute(); ?>" class="post-title"><h1><?php the_title(); ?></h1></a>
