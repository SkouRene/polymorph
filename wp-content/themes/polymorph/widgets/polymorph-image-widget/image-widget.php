...
class Tribe_Image_Widget extends WP_Widget {
	...
	function Tribe_Image_Widget() {
		...
		$this->WP_Widget('widget_sp_image', __('Polymorph: Image Widget', 'image_widget'), $widget_ops, $control_ops);
